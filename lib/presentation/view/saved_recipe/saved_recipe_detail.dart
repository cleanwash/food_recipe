...
class _SavedRecipeDetailState extends State<SavedRecipeDetail> {
  late SavedRecipeDetailViewModel viewModel;

  @override
  void initState() {
    super.initState();
    viewModel = SavedRecipeDetailViewModel(
      creatorDataSource: CreatorProfileDataSource(),
      ingredientDataSource: IngredientDataSourceImpl(),
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<SavedRecipeDetailViewModel>.value(
      value: viewModel,
      child: Scaffold(
        appBar: AppBar(
          leading: IconButton(
