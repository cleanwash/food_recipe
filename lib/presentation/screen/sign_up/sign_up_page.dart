      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            InputField(labelText: 'Confirm Password', hintText: 'Retype Password'),
            SizedBox(height: 20),
            Row(
              children: [
                Checkbox(
                ...
                Text('Accept terms & Condition', style: TextStyles.normalTextRegular.copyWith(color: Colors.orange)),
              ],
            ),
            SizedBox(height: 20),
            ElevatedButton(
            ...
            SizedBox(height: 20),
            Center(child: Text('Or Sign in With', style: TextStyles.normalTextRegular)),
            SizedBox(height: 20),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
